    ...
    <div className="px-4 pt-10 md:px-10 flex-1 min-h-screen bg-gray-50">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl">
        {dashboardCards.map((card, index) => (
          <div
            key={index}
            className="flex gap-2 items-center justify-between p-4 rounded-md border border-gray-300 bg-white shadow-sm"
          >
            <div>
        ...
        <div className="flex flex-warp items-start gap-6 mb-8 w-full">
          ...
          <div className="p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs">
            ...
            <p className="tex-gray-500">Revenue for current month</p>
