...
const ManageBookings = () => {  
  ...
  const [bookings, setCarBookings] = useState([])

  const fetchOwnerbookings = async ()=>{
    setCarBookings(dummyMyBookingsData)
  }
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title
        ...
        subTitle="Track all cutomer booking, aprove or cancel request, and manage booking statuses" 
      />
